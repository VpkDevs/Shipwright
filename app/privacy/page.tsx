      ...
      <div className="max-w-4xl mx-auto px-6 py-12">
        ...
        <div className="space-y-8 text-slate-300">
          <div>
            ...
            <div className="space-y-3">
              <div>
                ...
                <p className="text-sm">
                  Your GitHub username, display name, email, and avatar. A temporary OAuth token
                  used only during your session — never stored.
                </p>
              </div>
              <div>
                <h3 className="font-medium text-slate-200">From Your Repositories</h3>
                <p className="text-sm">
                  We read <code className="bg-slate-700 px-1 rounded text-xs">package.json</code>,
                  README, file tree, and environment variable <em>names</em> (never values) to
                  perform analysis.
                </p>
              </div>
              <div>
                ...
                <p className="text-sm">
                  Processed by Stripe. We store your Stripe customer ID, plan type, and remaining
                  credits. We never store card numbers.
                </p>
              </div>
            </div>
          </div>
              ...
              <table className="text-sm w-full">
                <thead>
                  <tr className="text-slate-400 border-b border-slate-700">
                    <th className="text-left py-2 pr-8">Data</th>
                    <th className="text-left py-2">Retention</th>
                  </tr>
                </thead>
                <tbody className="divide-y divide-slate-800">
                  <tr>
                    <td className="py-2 pr-8">GitHub profile data</td>
                    <td className="py-2">Until account deletion</td>
                  </tr>
                  <tr>
                    <td className="py-2 pr-8">Repo analysis results</td>
                    <td className="py-2">Not persisted — per request</td>
                  </tr>
                  <tr>
                    <td className="py-2 pr-8">API logs</td>
                    <td className="py-2">30 days</td>
                  </tr>
                  <tr>
                    <td className="py-2 pr-8">Payment data</td>
                    <td className="py-2">Per Stripe policy (7 years)</td>
                  </tr>
                </tbody>
              </table>
            </div>
          ...
          <div>
            ...
            <p className="text-sm">
              You may request access, deletion, or correction of your data. Email{" "}
          ...
          <div>
            ...
            <p className="text-sm">
              All data in transit is encrypted via TLS. GitHub tokens are session-only. We use
              encrypted database connections. We do not use tracking or advertising cookies.
            </p>
          </div>
